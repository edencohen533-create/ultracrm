      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Panel title={`עסקאות (${c.deals.length})`} actions={<Link href="/leads?status=converted" className="text-xs text-accent underline hover:underline">הכול</Link>} bodyClassName="p-0">
