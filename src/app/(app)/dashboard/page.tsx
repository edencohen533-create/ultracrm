      ...
      {d.telephony && (
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
            ...
            <Link href="/dialer" className="bg-panel-2 border border-line rounded-lg px-3 py-2 text-sm flex items-center justify-center hover:border-accent">לחייגן →</Link>
          </div>
        </section>
      )}
