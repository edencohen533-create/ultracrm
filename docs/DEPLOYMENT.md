...
- **ניווט (2026-09-25)**: מסך הבית הוא `/leads`; `/dashboard` ו-`/dialer` מפנים אליו, `/leads/[id]` מפנה לכרטיס איש הקשר. הדוחות ב-`/reports` (`/analytics` ו-`/manager/calls` נשארו כנתיבים). ראו `docs/LEAD_WORKSPACE.md`.
