...
import { checkConnection, disconnectConnection, runSetupSteps, sendTestMessage } from "@/server/services/embedded-signup-service";

export const dynamic = "force-dynamic";
export const maxDuration = 60;

const schema = z.object({
  action: z.enum(["check", "retry_setup", "disconnect", "test_send"]),
